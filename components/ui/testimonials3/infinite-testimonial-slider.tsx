...
export const InfiniteTestimonialSlider: React.FC<InfiniteTestimonialSliderProps> = ({
  ...
  return (
    <div className={`w-full py-16 bg-gradient-to-br from-gray-50 to-blue-50 ${className}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            The truth is, our reputation speaks louder than any advertisement ever could. Here&apos;s what neighbors across Dallas-Fort Worth are saying about their experience with Mike&apos;s Garage Door Repair Center.
          </p>
        </div>
          ...
          >
            {duplicatedTestimonials.map((testimonial, index) => (
              <div
                ...
                className="flex-shrink-0 w-80 bg-white rounded-xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
              >
                {/* Rating */}
                <div className="mb-4">
                ...
                <div className="flex items-center space-x-4">
                  <div className="relative">
                    {testimonial.profilePic ? (
                      ...
                      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center border-2 border-blue-100">
