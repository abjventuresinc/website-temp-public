...
import { CONTACT, BUSINESS_INFO } from '@/lib/business-config';
...
export default function SimpleCTASection({
  ...
  secondaryButtonText = `Call Now: ${CONTACT.phone}`,
  secondaryButtonHref = `tel:+1${CONTACT.phone.replace(/[^0-9]/g, '')}`
}: SimpleCTASectionProps) {
  return (
    <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl p-8 sm:p-12 text-center shadow-lg">
