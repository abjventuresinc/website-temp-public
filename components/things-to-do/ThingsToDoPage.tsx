...
const ThingsToDoPage: React.FC<ThingsToDoPageProps> = ({ cityData, city }) => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative min-h-[55dvh] pt-40 h-[55dvh] sm:min-h-[70vh] lg:h-[55vh] xl:h-[50vh] flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-primary overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full z-0 overflow-hidden pointer-events-none brightness-50">
          <div className="w-full h-full bg-gradient-to-br from-gray-900 via-gray-800 to-primary">
            <Image
