...
export default function StatsSection() {
  ...
  const stats = [
    { icon: <Award className="w-8 h-8" />, value: 85, label: "Projects Completed", suffix: "+" },
    { icon: <Users className="w-8 h-8" />, value: 320, label: "Happy DFW Clients", suffix: "+" },
    { icon: <Calendar className="w-8 h-8" />, value: 6, label: "Years Serving DFW", suffix: "" },
