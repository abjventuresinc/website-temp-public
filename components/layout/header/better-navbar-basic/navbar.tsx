...
import { MenuIcon, Home, Info, MapPin, FileText, HelpCircle, Image as ImageIcon } from "lucide-react";
...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "@/components/layout/header/better-navbar-basic/accordion";
      ...
      <div className=" w-full px-4">
        <nav className="flex items-center px-4">
          ...
          <div className="flex-shrink-0">
            ...
            >
              ...
              <span className={`text-lg font-semibold tracking-tighter transition-colors duration-300 ${
                isScrolled ? 'navbar-text-dark' : 'navbar-text-white'
              }`}>
                Example Company
              </span>
            </Link>
            ...
            <NavigationMenu className="hidden lg:block">
              <NavigationMenuList>
                <NavigationMenuItem>
                  <NavigationMenuLink
                    href="/service-areas/"
                    className={`${navigationMenuTriggerStyle()} ${isScrolled ? 'bg-background' : 'navbar-text-white hover:text-white bg-transparent'}`}
                  >
                    Service Areas
                  </NavigationMenuLink>
                </NavigationMenuItem>
                <NavigationMenuItem>
                  <NavigationMenuTrigger className={isScrolled ? 'bg-background' : 'navbar-text-white hover:text-white bg-transparent'}>Services</NavigationMenuTrigger>
                  <NavigationMenuContent>
                ...
                <NavigationMenuItem>
                  <NavigationMenuTrigger className={isScrolled ? 'bg-background' : 'navbar-text-white hover:text-white bg-transparent'}>About Us</NavigationMenuTrigger>
                  <NavigationMenuContent>
          ...
          <button
            ...
            className={`lg:hidden p-3 rounded-md hover:bg-muted/70 transition-colors aria-label="Menu Button" aria-label="Menu Button" ${
