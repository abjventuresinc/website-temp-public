...
} from "@/components/layout/header/better-navbar-basic/navigation-menu"
      ...
      <NavigationMenuList>
        ...
        <NavigationMenuItem>
          <NavigationMenuLink asChild>
            <Link
              href="/service-areas/"
              className={cn(
                "group inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 font-medium focus:outline-none disabled:pointer-events-none disabled:opacity-50 group text-sm font-600 tracking-wide uppercase transition-colors duration-200 text-gray-900 hover:bg-primary/10 hover:text-primary data-[state=open]:bg-primary/10 data-[state=open]:text-primary"
              )}
            >
              Service Areas
            </Link>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className={cn(
            "text-sm font-600 tracking-wide uppercase transition-colors duration-200","text-gray-900 hover:bg-primary/10 hover:text-primary data-[state=open]:bg-primary/10 data-[state=open]:text-primary"
          )}>
            Services
          </NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="grid gap-3 p-4 md:w-[500px] lg:w-[800px] lg:grid-cols-2 lg:grid-rows-2">
              <li className="row-span-3">
                <NavigationMenuLink asChild>
                  <Link
                    className="flex h-full w-full hover:shadow-lg hover:scale-102 transition-all duration-200 select-none flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-none focus:shadow-md relative overflow-hidden"
