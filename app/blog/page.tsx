...
export default function BlogPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Newsletter Signup */}
      <div className="bg-gradient-to-r from-primary to-primary-hover py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="max-w-md mx-auto flex gap-4">
            <input 
              ...
              className="flex-1 px-4 py-3 rounded-lg text-foreground bg-background border border-border focus:outline-none focus:ring-2 focus:ring-primary-foreground/20 focus:border-primary-foreground/30 transition-all duration-200"
              aria-label="Email address for newsletter subscription"
            />
            <button className="bg-background text-primary-foreground px-6 py-3 rounded-lg font-medium hover:bg-bg-secondary transition-all duration-200 shadow-sm">
              Subscribe
            </button>
          </div>
        </div>
