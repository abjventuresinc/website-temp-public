...
const businessCitySchemas = generateDynamicStructuredData('/example-city-st/', {
  cityData: {
    name: "Example City",
    state: "ST",
    description: "Professional services in Example City, ST",
    latitude: "40.7128",
    longitude: "-74.0060",
...
const serviceAreaSchemas = generateDynamicStructuredData('/north-town-st/', {
  cityData: {
    name: "North Town",
    state: "ST",
    description: "We serve North Town, ST with professional services",
    latitude: "40.7300",
    longitude: "-74.0100",
...
**Usage Example:**
```tsx
const thingsToDoSchemas = generateDynamicStructuredData('/things-to-do-in-example-city/', {
  thingsToDoData: {
    cityName: "Example City",
    state: "ST",
    description: "Discover amazing things to do in Example City",
...
const serviceSchemas = generateDynamicStructuredData('/garage-door-installation/', {
  serviceData: {
    ...
    areaServed: ["Example City", "North Town", "South Town"],
    price: "500"
  },
  breadcrumbs: [...]
})
