  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <DynamicHeader 
        ...
        description="We are committed to protecting your privacy and personal information. This policy explains how we collect, use, and safeguard your data when you use our garage door services."
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 lg:p-12">
              <div className="prose prose-lg max-w-none">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-600 mb-2"><strong>Email:</strong> privacy@example.com</p>
                  <p className="text-gray-600 mb-2"><strong>Address:</strong> 123 Main Street, Example City, ST 12345</p>
