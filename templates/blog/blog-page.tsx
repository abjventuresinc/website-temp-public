...
export const metadata: Metadata = {
  title: 'Garage Door Blog | Expert Tips & Guides | Example Company',
  description: 'Expert tips, guides, and insights for garage door maintenance, repair, and installation in Texas. Learn from our professional team.',
  keywords: 'garage door blog, garage door tips, garage door guides, garage door maintenance, Texas garage doors',
  openGraph: {
    title: 'Garage Door Blog | Example Company',
    description: 'Expert tips and guides for garage door maintenance, repair, and installation.',
    type: 'website',
  },
};
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert tips, guides, and insights for maintaining and designing beautiful garage doors in Texas
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{blogPosts[0].author.title}</p>
                    </div>
                  </div>
                  <Link 
