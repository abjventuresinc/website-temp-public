...
{enhancedService?.contentVariations?.opening && (
  <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 sm:p-8 shadow-md border-l-4 border-primary">
...
{enhancedService?.contentVariations?.closing && (
  <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-xl p-6 sm:p-8 shadow-md border border-primary/20">
    <p className="text-lg text-gray-700 leading-relaxed">
      {enhancedService.contentVariations.closing}
    </p>
  </div>
