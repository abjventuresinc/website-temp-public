...
import { getSEOConfig, siteConfig, getOrganizationSchema, getLocalBusinessSchema, getWebsiteSchema, getServiceSchema, getArticleSchema, getCityLocalBusinessSchema, getCityPlaceSchema, getServicePageSchema, getThingsToDoSchema, getFAQSchema, getHomeAndConstructionSchema, getPortfolioSchema } from './seo-config';
 ...
 * @example
 * // For city pages
 * generateDynamicStructuredData('/example-city-st/', {
 *   cityData: { name: 'Example City', state: 'ST', description, latitude, longitude, servicesOffered },
 *   breadcrumbs: [...]
 * })
 * 
 * @example
 ...
 * generateDynamicStructuredData('/things-to-do-in-example-city/', {
 *   thingsToDoData: {
 *     cityName: 'Example City',
 *     state: 'ST',
 *     description: 'Discover amazing things to do...',
 *     url: 'https://example.com/things-to-do-in-example-city/',
 *     latitude: 40.7128,
 *     longitude: -74.0060,
...
export function generateDynamicStructuredData(
  ...
  // For homepage - Website, LocalBusiness, HomeAndConstructionBusiness
